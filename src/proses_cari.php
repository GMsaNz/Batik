...
// Query pencarian dengan proteksi SQL injection
    ...
    <div class="search-container">
        ...
        <?php else: ?>
            <div class="no-results">
                <p>Maaf, tidak ditemukan produk dengan kata kunci "<?= htmlspecialchars($search_query) ?>"</p>
                <a href="produk.php" class="product-button"
