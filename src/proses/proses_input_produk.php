    ...
    window.location="../dashboard.php"</script>';
        ...
        if (mysqli_num_rows($select) > 0) {
            ...
            if (move_uploaded_file($_FILES['foto']['tmp_name'], $target_file)) {
                $query = mysqli_query($conn, "INSERT INTO tb_produk (foto, kode_produk, nama_barang, deskripsi, katagori, harga, stok) 
VALUES ('" . $kode_rand . $_FILES['foto']['name'] . "', '$kode_produk','$nama_barang', '$deskripsi', '$kategori', '$harga', '$stok')");
